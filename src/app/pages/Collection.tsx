...
export function Collection() {
  useDocumentMeta({
    ...
    description:
      'Six single-origin lots from Colombia, Peru, Ethiopia and Yemen — each roasted to order as Low Voltage, Full Charge or Maximum Overdrive, ground to your brew method or shipped whole bean.',
    path: '/collection',
  });
